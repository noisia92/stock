...
##체결에 관련된 함수
    ...
    def _opw00018(self, rqname, trcode):
        ...
        #아래 single, multi가 있는 dictionary 구조가 동작하기 위해서는
        #.reset_opw00018_output() 실행이 선행되어야 한다
        #single data
        ...
        #모투는 리턴값 1, 실투는 값 없음으로 리턴값이 나옴
        print(self.get_server_gubun())
...
if __name__ == "__main__":
    ...
    #d+2 계좌 추정 잔액(계좌 수동입력)
    #kiwoom.set_input_value("계좌번호", "8145981011")
